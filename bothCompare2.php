...
<body> 
   ...
   <input type="submit" value = "search" name="submit" style="font-size: 20px;">
      ...
      <div align="left"><p style="color: gray; font-size: 40px;background-color: skyblue"><a href="http://localhost/myProject.php" style="font-size: 40px;">cheapbook</a></p></div>
   ...
   //-----------------------------------touriffy.com done--------------------------------
    ...
    for( $i = 1; $i < count($onlyHotel); $i++)
     {
        ...
        if(array_key_exists($name1[0], $allHotel))
        {
          $pr=$allHotel["$name1[0]"];
          if($pr>$without_BDT[1])
        ...
        $allHotel["$name1[0]"]  = $without_BDT[1];$totalHotel++;
      }
    ...
    // $top+=300;
     ...
     echo "<div  style='position: absolute; top: " .$top."px; background-color:pink;left:350px;font-color:gray;'>";
     $top+=200;
     ...
     foreach ($allHotel as $key => $value) {
      if($key!="0"){
       if(array_key_exists($key,$amarroom_hotel_name_with_price)and array_key_exists($key,$touriffy_hotel_name_with_price))
          {
           //echo "both $value $key<br>";
           if($touriffy_hotel_name_with_price[$key] < $amarroom_hotel_name_with_price[$key])
            {
            ...
            $top+=300;
                ...
                echo "'<p align='center' style=' 
                left 760px;font-size: 25px; color:white'>$key</p> <br><p align='right' style='color:green; font-size: 20px;'><a href =' ". $amarroom_hotel_name_with_deal_link[$key] ."' style = 'color:green;'>amarroom.com= $amarroom_hotel_name_with_price[$key]/- </a><br><strike style='color:red'> <a href =' ". $touriffy_hotel_name_with_deal_link[$key] ."' style = 'color:red;'> touriffy.com = $touriffy_hotel_name_with_price[$key]/-</a></strike></h3>";
                echo "<br>";
       ...
       else if(array_key_exists($key,$amarroom_hotel_name_with_price))
       {
           echo "<div class='t' style='position: absolute; top: " .$top."px; background-color:gray;''>";
            ?>
            <?php
       ...
       else if(array_key_exists($key,$touriffy_hotel_name_with_price))
       {
          echo "<div class='t' style='position: absolute; top: " .$top."px; background-color:gray;''>";
            ?>
